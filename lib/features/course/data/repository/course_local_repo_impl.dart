...
final courseLocalRepositoryImplProvider = Provider.autoDispose<ICourseRepository>(
        (ref) => CourseLocalRepositoryImpl(courseLocalDataSource: ref.read(courseLocalDataSourceProvider))
);
